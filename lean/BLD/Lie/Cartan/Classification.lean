              ...
              · by_cases hn4 : n = 4
                ...
                · by_cases hn5 : n = 5
                  ...
                  · -- n ≥ 6: Ẽ₈ subgraph → contradiction
                    ...
                    have hfvu_ne : fv_idx ≠ u_idx := dns _ _ (by simp [he_fv, he_u]; try omega)
                    have holu_ne : ol_idx ≠ u_idx := dns _ _ (by simp [he_ol, he_u]; try omega)
                    have hw2u_ne : w2_idx ≠ u_idx := dns _ _ (by simp [he_w2, he_u]; try omega)
                    have hw3u_ne : w3_idx ≠ u_idx := dns _ _ (by simp [he_w3, he_u]; try omega)
                    have hw4u_ne : w4_idx ≠ u_idx := dns _ _ (by simp [he_w4, he_u]; try omega)
                    have hw5u_ne : w5_idx ≠ u_idx := dns _ _ (by simp [he_w5, he_u]; try omega)
                    have hw6u_ne : w6_idx ≠ u_idx := dns _ _ (by simp [he_w6, he_u]; try omega)
                    -- Vertex ≠ v
                    ...
                    have hfv_ol : fv ≠ ol := vne _ _ (by simp [he_fv, he_ol]; try omega)
                    have hfv_w2 : fv ≠ w2 := vne _ _ (by simp [he_fv, he_w2]; try omega)
                    have hfv_w3 : fv ≠ w3 := vne _ _ (by simp [he_fv, he_w3]; try omega)
                    have hol_w2 : ol ≠ w2 := vne _ _ (by simp [he_ol, he_w2]; try omega)
                    have hw2_w3 : w2 ≠ w3 := vne _ _ (by simp [he_w2, he_w3]; try omega)
                    have hw2_w4 : w2 ≠ w4 := vne _ _ (by simp [he_w2, he_w4]; try omega)
                    have hw3_w4 : w3 ≠ w4 := vne _ _ (by simp [he_w3, he_w4]; try omega)
                    have hw3_w5 : w3 ≠ w5 := vne _ _ (by simp [he_w3, he_w5]; try omega)
                    ...
                    have hAu_ol : A u ol = 0 := by
                      rw [← hu_idx]; exact Azz u_idx ol_idx
                        (by simp [he_u, he_ol] <;> omega) (by simp [he_u, he_ol] <;> omega)
                        (by simp [he_u, he_ol] <;> omega) (by simp [he_u, he_ol] <;> omega)
                        (by simp [he_u, he_ol] <;> omega)
