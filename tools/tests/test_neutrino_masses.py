...
def test_dm2_ratio() -> None:
    ...
    assert_all_pass([tools.bld.Prediction("\u0394m\u00b2\u2083\u2082/\u0394m\u00b2\u2082\u2081", predicted, obs_ratio, unc)])
...
def test_neutrino_mass_bound() -> None:
    ...
    assert_all_pass([tools.bld.TestResult("KATRIN_bound", m_nu_ev < 0.45, m_nu_ev)])
...
def test_missing_b_suppression() -> None:
    ...
    assert_all_pass([tools.bld.TestResult(
