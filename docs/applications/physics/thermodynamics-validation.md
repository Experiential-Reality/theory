...
![Fokker-Planck Validation](../figures/fokker_planck_validation.png)

*Four-panel visualization showing: (1) Entropy vs time (increasing), (2) Entropy rate dS/dt (non-negative), (3) Final distribution, (4) Boltzmann equilibrium distribution.*
