...
See [Test Generation from BLD](./cross-language-compilation.md#test-generation-from-bld) for details.
...
See [Cross-Language Compilation](./cross-language-compilation.md#wgsl-generation-gpu-shaders-from-bld) for full details.
...
- [Discovery Method](../../theory/discovery-method.md) — The three questions
