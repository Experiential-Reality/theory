...
See [Validation Results](validation-results.md#noise-floor-analysis) for derivation details.
...
- [Discovery Method](theory/discovery-method.md) — How to find structure in any system
