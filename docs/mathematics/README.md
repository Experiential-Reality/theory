...
The BLD = Lie theory correspondence.
...
- [Cosmology Structure](./cosmology/cosmology-structure.md) — L/D = 20/4 = 5 derivation
...
- [Mathematician Path](../paths/mathematician.md) — Curated reading order
